...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (A == 1) {
        ...
        screenTransitions.startTransition(screenTransitions.WavyVertical, 500, true, false)
...
function Level_1 () {
    ...
    myTextSprite3 = fancyText.create("Where?", 0, 6, fancyText.serif_small)
    myTextSprite3.setPosition(80, 0)
    ...
    characterAnimations.setCharacterState(Character_1, characterAnimations.rule(Predicate.NotMoving, Predicate.FacingDown))
    tiles.placeOnTile(Character_1, tiles.getTileLocation(7, 0))
    scene.cameraFollowSprite(Character_1)
    controller.moveSprite(Character_1)
}
function Naming () {
    music.stopAllSounds()
    music.play(music.createSong(assets.song`Selection`), music.PlaybackMode.LoopingInBackground)
...
function Game_Challenge () {
    ...
    story.startCutscene(function () {
        ...
        story.printCharacterText("Ok.", "Professor McDale")
        story.printCharacterText("Pardon me, but what are your names. I can be very absent minded at times. I know that you came here from a different company to collaborate, but your names are at the tip of my tongue.", "Professor McDale")
        Naming2()
    })
}
